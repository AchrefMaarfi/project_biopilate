  ...
  return (
    <div className="mt-4 mx-8 md:mx-12 mb-12">
      <div className="relative mt-4 min-h-[736px] flex justify-center items-center">
        ...
        {/* contact info */}
        <section className="relative flex flex-wrap mx-2 justify-between items-center gap-10">
          <div className="flex flex-col justify-center items-start gap-4 text-white font-lato max-w-[35%] ml-10">
