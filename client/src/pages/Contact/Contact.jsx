  ...
  return (
    <div className="mt-4 mx-8 md:mx-12 mb-12">
      <div className="relative mt-4 min-h-[736px] flex justify-center items-center">
        ...
        <div className="absolute inset-0 bg-black from-black rounded-lg opacity-20"></div>
        {/* contact info */}
        <section className="relative flex mx-2 justify-start items-center gap-20">
          <div className="flex flex-col justify-center items-start gap-4 text-white font-lato max-w-[45%] mx-10">
          ...
          <div className="bg-white bg-opacity-50 rounded-[20px] p-9">
            <form className="flex flex-col gap-4">
              ...
              <input
                ...
                className="rounded-md px-2 py-1"
              />
              <input placeholder="Message" className="rounded-md px-2 py-1" />
              <button className="button-hover flex flex-col justify-center text-marron rounded-lg px-4 py-2 bg-white shadow-sm">
                Envoyer
              </button>
            </form>
          </div>
